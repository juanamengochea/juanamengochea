...
auto1.setModificarVehiculo("lamborghini", "porsche", 2022, 2019, "rosa");
console.log("\nDespués de modificar el auto:");
console.log(registro.obtenerTodosLosAutos());
moto1.setModificarVehiculo("ducati", "aprilia", 2023, 2024, "violeta");
console.log("\nDespués de modificar la moto:");
console.log(registro.obtenerTodasLasMotos());
camion1.setModificarVehiculo("Volvo", "FH16", 2019, 2018, "naranja");
